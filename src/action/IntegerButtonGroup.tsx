  ...
  for (let i = startValue; i <= endValue; i++) {
    PhaseButtons.push(
      <button
        ...
        value={i.toString()}
        className={cn(
          "w-full px-0 hover:bg-purple-100/40 dark:hover:bg-mirage-50/5",
          {
            "bg-primary/20 text-primary hover:bg-primary/25 dark:bg-primary-dark/20 dark:text-primary-dark dark:hover:bg-primary-dark/25":
              i === value,
          },
        )}
        onClick={() => onClick(i)}
